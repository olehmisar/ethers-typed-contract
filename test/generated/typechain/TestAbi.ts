...
export declare namespace TestAbi {
  export type NestedStructStruct = { nestedBalances: BigNumberish[] };

  export type NestedStructStructOutput = [BigNumber[]] & {
    nestedBalances: BigNumber[];
  };

  export type RootStructStruct = {
    name: string;
    age: BigNumberish;
    balances: BigNumberish[];
    nestedStruct: [
      [
        TestAbi.NestedStructStruct,
        TestAbi.NestedStructStruct,
        TestAbi.NestedStructStruct
      ][],
      [
  ...
  export type RootStructStructOutput = [
    string,
    BigNumber,
    BigNumber[],
    [
      [
        TestAbi.NestedStructStructOutput,
        TestAbi.NestedStructStructOutput,
        TestAbi.NestedStructStructOutput
      ][],
      [
...
export interface TestAbiInterface extends utils.Interface {
  functions: {
    ...
    "overloaded(uint256)": FunctionFragment;
    "overloaded(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "overloaded(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "overloaded(uint256,address)",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
...
export interface NoArgsEventObject {}
export type NoArgsEvent = TypedEvent<[], NoArgsEventObject>;

export type NoArgsEventFilter = TypedEventFilter<NoArgsEvent>;

export interface OneArgEventObject {
  a: string;
}
export type OneArgEvent = TypedEvent<[string], OneArgEventObject>;

export type OneArgEventFilter = TypedEventFilter<OneArgEvent>;

export interface TwoArgsEventObject {
  a: string;
  u: BigNumber;
}
export type TwoArgsEvent = TypedEvent<[string, BigNumber], TwoArgsEventObject>;
...
export interface TestAbi extends BaseContract {
  ...
  functions: {
    ...
    structTypes(
      overrides?: CallOverrides
    ): Promise<[TestAbi.RootStructStructOutput]>;
  ...
  estimateGas: {
    ...
    structTypes(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    structTypes(overrides?: CallOverrides): Promise<PopulatedTransaction>;
